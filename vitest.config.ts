...
export default defineConfig({
  ...
  test: {
    ...
    testTimeout: (process.env.RUN_ENGINE_LIVE ?? process.env.RUN_REPLIT_LIVE) ? 20_000 : 5_000,
    hookTimeout: (process.env.RUN_ENGINE_LIVE ?? process.env.RUN_REPLIT_LIVE) ? 20_000 : 5_000,
    ...
    exclude: (process.env.RUN_ENGINE_LIVE ?? process.env.RUN_REPLIT_LIVE)
      ? ["node_modules/**"]
