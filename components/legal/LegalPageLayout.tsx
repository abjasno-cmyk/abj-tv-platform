...
// Akcent právních stránek per vertikála (VEROX oranžová / ProudX modrá).
const ACCENT = TENANT.id === "proudx" ? "#6a8cff" : "#FFB782";
    ...
    <main className="min-h-[calc(100vh-68px)] bg-[#0E1116] px-4 py-8 text-[#E8ECF3] md:py-10">
      <div className="mx-auto w-full max-w-3xl">
        <header className="mb-8 border-b border-white/10 pb-5">
          <p className="text-[11px] uppercase tracking-[0.16em]" style={{ color: ACCENT }}>{TENANT.siteName} · právní a informační servis</p>
