...
export function LiveStrip({ viewers, headline }: LiveStripProps) {
  return (
    <div className="sticky top-[46px] z-40 border-b border-red-500/40 bg-[linear-gradient(90deg,rgba(30,5,11,0.97),rgba(8,17,34,0.96),rgba(5,23,45,0.96))] shadow-[0_8px_24px_rgba(0,0,0,0.45)] backdrop-blur">
