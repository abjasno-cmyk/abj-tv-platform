...
// rule that bleeds to the column edge — the connective tissue of the homepage.
export function SectionLabel({ index, title, kicker, right, id }: SectionLabelProps) {
  return (
    <div className="flex flex-wrap items-end gap-x-5 gap-y-2" id={id}>
      ...
      <h2 className="vx-display text-verox-ink" style={{ fontSize: "clamp(1.5rem, 3vw, 2.3rem)", lineHeight: 1 }}>
        {title}
      </h2>
