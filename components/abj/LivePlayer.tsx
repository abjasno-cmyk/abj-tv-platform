...
export function LivePlayer({
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-[rgba(17,17,17,0.1)] bg-white shadow-[0_18px_45px_rgba(17,17,17,0.08)]">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-20 -top-20 h-72 w-72 rounded-full bg-[rgba(227,6,19,0.14)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-28 left-1/3 h-56 w-56 rounded-full border border-[rgba(227,6,19,0.22)]"
      />
      ...
      <div className="relative aspect-video w-full overflow-hidden bg-[var(--abj-light)]">
        {videoId ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative flex h-40 w-40 items-center justify-center rounded-full border border-[rgba(227,6,19,0.3)] bg-white">
              <span className="h-5 w-5 rounded-full bg-[var(--abj-red)]" />
            </div>
          </div>
        )}

        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(227,6,19,0.14)_0%,rgba(255,255,255,0)_45%,rgba(17,17,17,0.62)_100%)]" />
        ...
        {isFiller ? (
          <div className="pointer-events-none absolute inset-0">
            ...
            <span className="abj-circular-return absolute inset-0 bg-[rgba(227,6,19,0.12)]" />
          </div>
        ) : null}
      </div>
