...
export default async function NazoryPreviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="vx-live vx-sub nazory-page">
      <div className="nazory-preview-head">
        <h1 className="section-h">NÁHLED ČLÁNKU</h1>
        <Link href={`/nazory/napsat/${article.id}`} className="nazory-btn">
          Zpět do editoru
        </Link>
      </div>
      <OpinionEditor
