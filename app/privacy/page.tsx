    ...
    <main className="min-h-[calc(100vh-68px)] bg-[#FBF8F2] px-4 py-10 text-verox-ink md:py-14">
      <div className="mx-auto w-full max-w-3xl">
        <header className="mb-9 border-b border-verox-line pb-6">
          ...
          <p className="vx-meta mt-4">Platné pro platformu VEROX</p>
        </header>
        ...
        <article className="jz-prose max-w-[70ch] space-y-6 text-[15px] leading-relaxed text-verox-charcoal md:text-base">
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">1. Kdo je správcem údajů</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">2. Jaké údaje zpracováváme</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">3. Proč údaje zpracováváme</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">4. Právní základ zpracování</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">5. Přihlášení přes Google a Facebook</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">6. Komentáře a veřejná aktivita</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">7. Komu údaje předáváme</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">8. Jak dlouho údaje uchováváme</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">9. Vaše práva</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">10. Smazání účtu</h2>
          ...
          <section className="space-y-2">
            <h2 className="vx-kicker text-verox-orangeDeep">11. Změny těchto zásad</h2>
            <p>
