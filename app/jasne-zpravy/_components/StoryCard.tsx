  ...
  return (
    <article
      className={`border bg-white ${
        emphasize
          ? "rounded-3xl border-[#F37021]/30 p-6 shadow-[0_10px_28px_rgba(17,17,17,0.08)]"
          : "rounded-2xl border-gray-200 p-4 shadow-sm"
      }`}
    >
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center rounded-full bg-[#F37021]/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-[0.1em] text-[#B04A00]">
      ...
      {item.why_it_matters ? (
        <div className="mt-3 border-l-2 border-[#F37021] bg-[#fff7f1] px-3 py-2">
      ...
      <footer className="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-gray-100 pt-3">
        ...
        <Link href={href} className="text-sm font-bold uppercase tracking-[0.08em] text-[#F37021] hover:text-[#cc5500]">
          Číst zprávu
        </Link>
      </footer>
    </article>
