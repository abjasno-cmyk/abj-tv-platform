...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // /archiv, /program, /v-kostce, /jasne-zpravy záměrně mimo sitemapu:
    // sirotčí stránky bez navigace s AI obsahem bez označení (AI Act čl. 50(4))
    // — neindexovat, dokud se nerozhodne produktově + nedoplní AI štítky.
